...
var GetCostDataCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if authFlag {
			...
			getLambdaCostDetail(region, crossAccountRoleArn, acKey, secKey, table, externalId)
		}
	},
}

func getLambdaCostDetail(region string, crossAccountRoleArn string, accessKey string, secretKey string, table string, externalId string) (*costexplorer.GetCostAndUsageOutput, error) {
